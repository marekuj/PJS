...
def main(args):
    ...
    args.rpmbuild_directory=os.path.expanduser(args.rpmbuild_directory)
    args.rpm_store_directory=os.path.expanduser(args.rpm_store_directory)
    args.project_directory=os.path.expanduser(args.project_directory)
